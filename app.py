...
def mostrar_pesquisa_descricao(frame):
    """Exibe os campos de pesquisa e descrição no frame direito."""
    # Limpa o frame atual
    ...
    def executar():
        ...
        error_label.configure(text="")  # Limpa mensagem de erro
...
def mostrar_planilhas(frame):
    """Exibe a lista de planilhas no frame direito."""
    # Limpa o frame atual
    for widget in frame.winfo_children():
        widget.destroy()
    ...
    planilhas_frame = ctk.CTkScrollableFrame(frame, fg_color="#2A2F30", corner_radius=10)
...
def main():
    ...
    # Frame lateral esquerdo para os botões
    sidebar_frame = ctk.CTkFrame(root, width=200, fg_color="#2A2F30", corner_radius=0)
    ...
    # Frame direito para exibir o conteúdo
    content_frame = ctk.CTkFrame(root, fg_color="#1C2526")
    ...
    ctk.CTkLabel(
        content_frame,
        text="Selecione uma opção na barra lateral para começar.",
        font=("Arial", 14),
        text_color="white"
    ).pack(pady=10)

    # Botão "Pesquisa e Descrição"
    ctk.CTkButton(
        sidebar_frame,
        text="Pesquisa e Descrição",
        command=lambda: mostrar_pesquisa_descricao(content_frame),
        fg_color="#28A745",  # Verde
        hover_color="#218838",
        font=("Arial", 14, "bold"),
        text_color="white",
    ...
    ctk.CTkButton(
        sidebar_frame,
        text="Planilhas",
        command=lambda: mostrar_planilhas(content_frame),
        fg_color="#28A745",  # Verde
        hover_color="#218838",
        font=("Arial", 14, "bold"),
        text_color="white",
